...
UI_TESTS=(derived_views selection_survives tree_selection list_invariants platform_claims sort_keeps_model headless_canvas string_ownership undo_stack undo_group style_release ctxmenu_rebuild no_echo roundtrip keymap)
